...
export default defineConfig({
  ...
  schema: ["./src/schema/store.ts", "./src/schema/store-admin.ts", "./src/schema/staff.ts", "./src/schema/staff-store.ts", "./src/schema/staff-invite.ts", "./src/schema/tip.ts", "./src/schema/payout.ts", "./src/schema/payout-ledger.ts", "./src/schema/webhook-event.ts"],
  out: "./drizzle",

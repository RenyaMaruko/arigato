...
| Rose Soft | #fde8ee | 選択中スタンプの背景・ローズ系の淡い面 |
...
- サイズ: 48px / 円（border-radius 50%）
- 未選択: 背景 #f3f4f6
- 選択中: 背景 #fde8ee / ボーダー 2px solid #ec3a6d
- 絵文字サイズ: 21px
...
スタンプは即時選択。選択中は淡いローズ背景 + ローズ枠で表現する。
